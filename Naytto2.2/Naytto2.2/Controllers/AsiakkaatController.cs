...
namespace Naytto2._2.Controllers
{
    public class AsiakkaatController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "asiakasId,Yhteyshenkilö,Yritysnimi,Puhelin,Sähköposti")] Asiakkaat asiakkaat)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "asiakasId,Yhteyshenkilö,Yritysnimi,Puhelin,Sähköposti")] Asiakkaat asiakkaat)
        {
            if (ModelState.IsValid)
            {
